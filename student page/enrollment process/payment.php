            ...
            <div class="row g-4 mb-4">
                <div class="col-12 col-lg-7">
                    <div class="card border-0 rounded-4 h-100" style="background-color: #f8fafc;"><div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12"><div class="border rounded-4 p-3 bg-white"><div class="small text-uppercase fw-bold text-secondary mb-1" style="letter-spacing: 2px;">Bank Name</div><div class="fw-semibold fs-5">Banco de Filipinas</div></div></div>
                            <div class="col-12 col-md-6"><div class="border rounded-4 p-3 bg-white"><div class="small text-uppercase fw-bold text-secondary mb-1" style="letter-spacing: 2px;">Account Name</div><div class="fw-semibold fs-5">Digital University</div></div></div>
